...
/**
 * Created by Nuriddin.Baideuov on 03.07.2015.
 */
@ManagedBean
@SessionScoped
public class KiscBean implements Serializable {
...
//    public static final String[] CA_NAME_DETAILS = {"C=KZ", "O=KISC", "CN=KISC Beta CA"};
    ...
    public String getSignatureInfo(String caUrl, String signature, String respondentBin, String respondentIdn, String languageCode) {
        ...
        if (Security.getProvider(GammaTechProvider.PROVIDER_NAME) == null) Security.addProvider(new GammaTechProvider());
        if (respondentBin == null || respondentBin.trim().isEmpty()) return "ERROR: " + resMap.get(languageCode + "_RESPONDENT_BIN_EMPTY");
            ...
            if (extensionBytes == null) {
                ...
                while (subjectAltNames.hasMoreElements()) {
                    ...
                    if (authority == null) {
                        ...
                        if (bin == null && value.equals(respondentBin)) {
                            bin = value;
                        }
