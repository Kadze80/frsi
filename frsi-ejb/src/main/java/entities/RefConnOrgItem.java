 ...
 */
public class RefConnOrgItem extends AbstractReference {
    public static final String REF_CODE = "ref_conn_org";

    // prepareCall
    public static final String READ = "PKG_FRSI_REF.REF_READ_CONN_ORG_LIST (?, ?, ?, ?)";
    public static final String READ_BY_FILTER = "PKG_FRSI_REF.REF_READ_CONN_ORG_L_BY_PARAMS (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    public static final String READ_HST = "PKG_FRSI_REF.REF_READ_CONN_ORG_HST_LIST (?, ?, ?, ?)";
    public static final String INSERT = "PKG_FRSI_REF.REF_INSERT_CONN_ORG (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    public static final String UPDATE = "PKG_FRSI_REF.REF_UPDATE_CONN_ORG (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    public static final String DELETE = "PKG_FRSI_REF.REF_DELETE_CONN_ORG (?, ?, ?, ?)";

    // read by filter
    public static OcsNumMap setOcsNumMapByFilters(OcsNumMap ocsNumMap, RefConnOrgItem item, Date date) throws SQLException {
        int num = 0;
    ...
    // Insert
    public static OcsNumMap setOcsNumMapForIns(OcsNumMap ocsNumMap, RefConnOrgItem item) throws SQLException{
        int num = 0;
    ...
    // Update
    public static OcsNumMap setOcsNumMapForUpd(OcsNumMap ocsNumMap, RefConnOrgItem item) throws SQLException {
        int num = 0;
    ...
    public static OcsNumMap setOcsNumMapForEdit(OcsNumMap ocsNumMap, RefConnOrgItem item, int num, String mode) throws SQLException{
        ocsNumMap.getOcs().setString(++num, item.getCode());
    ...
    // for Cursor
    public static RefConnOrgItem setItemFromCursor(ResultSet cursor) throws SQLException{
        RefConnOrgItem item = new RefConnOrgItem();
        item = (RefConnOrgItem) AbstractReference.setDefaultItemFromCursor(item, cursor);
        item.setShortNameRu(cursor.getString("SHORT_NAME"));
        return item;
    }

    // for History Cursor
    public static RefConnOrgItem setItemHstFromCursor(ResultSet cursor) throws SQLException{
        RefConnOrgItem item = setItemFromCursor(cursor);
        item = (RefConnOrgItem) AbstractReference.setDefaultHstItemFromCursor(item, cursor);
        return item;
    }
