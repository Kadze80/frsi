...
@ManagedBean
@SessionScoped
public class PickSecurityBean implements Serializable {
	...
	private List<RefSecuritiesItem> securities;
	private RefSecuritiesItem selectedSecurity;
	...
	public String getPickedIssuerValue() {
		return selectedIssuer == null ? null : selectedIssuer.getNameRu();
	}

	public void setPickedIssuerValue(String value) {}

	public String getPickedSecurityValue() {
		return selectedSecurity == null ? null : selectedSecurity.getNin();
	}

	public void setPickedSecurityValue(String value) {}
	...
	public void refreshSecurities() {
		securities = selectedIssuer == null ? null : sessionBean.getReference().getSecuritiesByIssuerId(sessionBean.getIntegration().getNewDateFromBackEndServer(), selectedIssuer.getId());
		if (securities.isEmpty()) selectedSecurity = null;
	}

	public List<RefSecuritiesItem> getSecurities() {
		return securities;
	}

	public void setSecurities(List<RefSecuritiesItem> securities) {
		this.securities = securities;
	}

	public RefSecuritiesItem getSelectedSecurity() {
		return selectedSecurity;
	}

	public void setSelectedSecurity(RefSecuritiesItem selectedSecurity) {
